...
func TestTransformBrowserURLToAPIURL(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedURL: "https://jpmc.fa.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions?onlyData=true&expand=requisitionList.workLocation,requisitionList.otherWorkLocations,requisitionList.secondaryLocations,flexFieldsFacet.values,requisitionList.requisitionFlexFields&finder=findReqs;siteNumber=CX_1001,facetsList=LOCATIONS%3BWORK_LOCATIONS%3BWORKPLACE_TYPES%3BTITLES%3BCATEGORIES%3BORGANIZATIONS%3BPOSTING_DATES%3BFLEX_FIELDS,limit=25,offset=0,lastSelectedFacet=CATEGORIES,locationId=300000000289738,selectedCategoriesFacet=300000086152753,selectedPostingDatesFacet=7,sortBy=POSTING_DATES_DESC",
			expectError: false,
		},
		{
			...
			expectedURL: "https://jpmc.fa.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions?onlyData=true&expand=requisitionList.workLocation,requisitionList.otherWorkLocations,requisitionList.secondaryLocations,flexFieldsFacet.values,requisitionList.requisitionFlexFields&finder=findReqs;siteNumber=CX_1001,facetsList=LOCATIONS%3BWORK_LOCATIONS%3BWORKPLACE_TYPES%3BTITLES%3BCATEGORIES%3BORGANIZATIONS%3BPOSTING_DATES%3BFLEX_FIELDS,limit=25,offset=0,lastSelectedFacet=CATEGORIES,selectedCategoriesFacet=300000086152753,selectedPostingDatesFacet=7,sortBy=POSTING_DATES_DESC",
			expectError: false,
		},
		{
			...
			expectedURL: "https://jpmc.fa.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions?onlyData=true&expand=requisitionList.workLocation,requisitionList.otherWorkLocations,requisitionList.secondaryLocations,flexFieldsFacet.values,requisitionList.requisitionFlexFields&finder=findReqs;siteNumber=CX_1001,facetsList=LOCATIONS%3BWORK_LOCATIONS%3BWORKPLACE_TYPES%3BTITLES%3BCATEGORIES%3BORGANIZATIONS%3BPOSTING_DATES%3BFLEX_FIELDS,limit=25,offset=0,selectedPostingDatesFacet=7,sortBy=POSTING_DATES_DESC",
			expectError: false,
		},
		{
			...
			expectedURL: "https://jpmc.fa.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions?onlyData=true&expand=requisitionList.workLocation,requisitionList.otherWorkLocations,requisitionList.secondaryLocations,flexFieldsFacet.values,requisitionList.requisitionFlexFields&finder=findReqs;siteNumber=CX_1001,facetsList=LOCATIONS%3BWORK_LOCATIONS%3BWORKPLACE_TYPES%3BTITLES%3BCATEGORIES%3BORGANIZATIONS%3BPOSTING_DATES%3BFLEX_FIELDS,limit=25,offset=0,lastSelectedFacet=CATEGORIES,locationId=300000000289738,selectedCategoriesFacet=300000086249838%3B300000086152753,selectedPostingDatesFacet=7,sortBy=POSTING_DATES_DESC",
			expectError: false,
		},
		{
			...
			expectedURL: "https://example.fa.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions?onlyData=true&expand=requisitionList.workLocation,requisitionList.otherWorkLocations,requisitionList.secondaryLocations,flexFieldsFacet.values,requisitionList.requisitionFlexFields&finder=findReqs;siteNumber=CX_2002,facetsList=LOCATIONS%3BWORK_LOCATIONS%3BWORKPLACE_TYPES%3BTITLES%3BCATEGORIES%3BORGANIZATIONS%3BPOSTING_DATES%3BFLEX_FIELDS,limit=25,offset=0,selectedCategoriesFacet=123456,selectedPostingDatesFacet=7,sortBy=POSTING_DATES_DESC",
			expectError: false,
		},
		{
...
func TestParseOracleAPIURL(t *testing.T) {
	tests := []struct {
		...
		{
			name:               "Valid API URL with comma separators",
			apiURL:             "https://jpmc.fa.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions?onlyData=true&expand=requisitionList.workLocation,requisitionList.otherWorkLocations,requisitionList.secondaryLocations,flexFieldsFacet.values,requisitionList.requisitionFlexFields&finder=findReqs;siteNumber=CX_1001,limit=25,offset=0,selectedCategoriesFacet=300000086152753,sortBy=POSTING_DATES_DESC",
			expectedBase:       "https://jpmc.fa.oraclecloud.com",
			expectedSiteNumber: "CX_1001",
			expectError:        false,
		},
		{
			name:               "API URL with facetsList parameter",
			apiURL:             "https://jpmc.fa.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions?onlyData=true&expand=requisitionList.workLocation,requisitionList.otherWorkLocations,requisitionList.secondaryLocations,flexFieldsFacet.values,requisitionList.requisitionFlexFields&finder=findReqs;siteNumber=CX_1001,facetsList=LOCATIONS%3BWORK_LOCATIONS,limit=25,offset=0",
			expectedBase:       "https://jpmc.fa.oraclecloud.com",
			expectedSiteNumber: "CX_1001",
			expectError:        false,
		},
