        ...
        <div class="modal-container" @click.stop>
            ...
            <div class="modal-content">
                <div class="job-info">
                    ...
                    <div v-if="job.job_insert_time" class="info-item">
                        <strong>Added to Database:</strong>
                        <span>{{ formatDateTime(job.job_insert_time) }}</span>
                    </div>
                ...
                <div class="job-description">
                    ...
                    <div
                        ...
                        v-html="formatJobDetails(job.job_details)"
                    ></div>
                </div>
            ...
            <div class="modal-footer">
                <a :href="job.job_link" target="_blank" class="apply-btn" @click="trackApplication">
                    Apply Now
                </a>
                <button @click="closeModal" class="close-btn-secondary">Close</button>
            </div>
        </div>
    </div>
</template>
